        ...
        <div id="ms-wrapper">
            ...
            <div id="example">
                <fieldset>
                    ...
                    <div id="ms-links">
                        <a target="_blank" href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=<?php echo $ms->to ?>&bcc=<?php echo $ms->bcc ?>&cc=<?php echo $ms->cc ?>&su=<?php echo $ms->subject ?>&body=<?php  echo $ms->body ?>&tf=1" class="sprite sprite-gmail"></a>
                        <a target="_blank" href="http://compose.mail.yahoo.com/?to=<?php echo $ms->to ?>&bcc=<?php echo $ms->bcc ?>&cc=<?php echo $ms->cc ?>&subject=<?php echo $ms->subject ?>&body=<?php echo $ms->body ?>" class="sprite sprite-yahoo"></a>
                        <a target="_blank" href="http://mail.live.com/mail/EditMessageLight.aspx?n=&page=Compose&to=<?php echo $ms->to ?>&bcc=<?php echo $ms->bcc ?>&cc=<?php echo $ms->cc ?>&subject=<?php echo $ms->subject ?>&body=<?php echo $ms->body ?>" class="sprite sprite-hotmail"></a>
                        <a target="_blank" href="mailto:<?php echo $ms->to ?>?bcc=<?php echo $ms->bcc ?>&cc=<?php echo $ms->cc ?>&subject=<?php echo $ms->subject ?>&body=<?php echo $ms->body ?>" class="sprite sprite-client"></a>
                    </div>
                </fieldset>
            </div>
        </div>
