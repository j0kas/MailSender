            ...
            return '<div id="ms-container">
                        ...
                        <div id="ms-links-wrapper">
                            ...
                            <div id="ms-gmail" class="ms-link">
                                <div onclick="window.open(\'https://mail.google.com/mail/u/0/?view=cm&fs=1&to=' . $this->to . '&bcc=' . $this->bcc . '&cc=' . $this->cc . '&su=' . $this->subject . '&body=' . $this->body . '\', \'\' ,\'width=800, height=600, menubar=yes, scrollbars=yes\')" class="ms-bg-img ms-gmail-bg" title="Gmail"></div>
                                <i class="ms-title">Gmail</i>
                            </div>
                            <div id="ms-orange" class="ms-link">
                                <div onclick="window.open(\'http://webmail.orange.fr/webmail/fr_FR/write.html\', \'\' ,\'width=800, height=600, menubar=yes, scrollbars=yes\')" class="ms-bg-img ms-orange-bg" title="Orange"></div>
                                <i class="ms-title">Orange</i>
                            </div>
                            <div id="ms-sfr" class="ms-link">
                                <div onclick="window.open(\'https://messagerie.sfr.fr/\', \'\' ,\'width=1200, height=600, menubar=yes, scrollbars=yes\')" class="ms-bg-img ms-sfr-bg" title="SFR"></div>
                                <i class="ms-title">SFR</i>
                            </div>
                            <div id="ms-hotmail" class="ms-link">
                                <div onclick="window.open(\'http://mail.live.com/mail/EditMessageLight.aspx?n=&page=Compose&to=' . $this->to . '&bcc=' . $this->bcc . '&cc=' . $this->cc . '&su=' . $this->subject . '&body=' . $this->body . '\', \'\' ,\'width=1200, height=600, menubar=yes, scrollbars=yes\')" class="ms-bg-img ms-hotmail-bg" title="Windows Live Hotmail"></div>
                                <i class="ms-title">Hotmail</i>
                            </div>
                            <div id="ms-yahoo" class="ms-link">
                                <div onclick="window.open(\'http://compose.mail.yahoo.com/?to=' . $this->to . '&bcc=' . $this->bcc . '&cc=' . $this->cc . '&su=' . $this->subject . '&body=' . $this->body . '\', \'\' ,\'width=1200, height=600, menubar=yes, scrollbars=yes\')" class="ms-bg-img ms-yahoo-bg" title="Yahoo Mail"></div>
                            ...
                            <div id="ms-laposte" class="ms-link">
                                <div onclick="window.open(\'https://webmailz.laposte.net/mail#1\', \'\' ,\'width=1200, height=600, menubar=yes, scrollbars=yes\')" class="ms-bg-img ms-laposte-bg" title="Laposte"></div>
                                <i class="ms-title">Laposte</i>
                            </div>
                            <div id="ms-numericable" class="ms-link">
                                <div onclick="window.open(\'https://webmail.numericable.fr/ncn/mail/send.php?msg_to=' . $this->to . '&msg_bcc=' . $this->bcc . '&msg_cc=' . $this->cc . '&msg_subject=' . $this->subject . '&msg_text=' . $this->body . '\', \'\' ,\'width=800, height=600, menubar=yes, scrollbars=yes\')" class="ms-bg-img ms-numericable-bg" title="Num&eacute;ricable"></div>
                        ...
                        <fieldset id="ms-text-proposition">
                            <legend>Proposition de texte <span>&agrave; copier/coller</span></legend>
                        ...
                        <fieldset id="ms-recipients-proposition">
                            <legend>Destinataires <span>&agrave; copier/coller</span></legend>
